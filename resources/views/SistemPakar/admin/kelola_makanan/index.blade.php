        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <x-primary-button onclick="window.location='{{ route('SistemPakar.admin.kelola_makanan.create') }}'">
                        Tambah Makanan
                    </x-primary-button>
                    <br>
                              ...
                              <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                  ...
                                  <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $food->nama_makanan }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $food->kategori->nama_kategori }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                        <div x-data="{ action: '' }">
                                            <x-primary-button tag="a" href="{{ route('SistemPakar.admin.kelola_makanan.edit', ['id' => $food->id]) }}"> Edit </x-primary-button>
                                            <x-danger-button
                                                x-on:click.prevent="
                                                    action = '{{ route('SistemPakar.admin.kelola_makanan.destroy', $food->id) }}';
                                                    $dispatch('open-modal', 'confirm-user-deletion-{{ $food->id }}')
                                                "
                                            >
                                                {{ __('Hapus') }}
                                            </x-danger-button>
                                            ...
                                            {{-- Modal Delete --}}
                                            <x-modal name="confirm-user-deletion-{{ $food->id }}" focusable>
