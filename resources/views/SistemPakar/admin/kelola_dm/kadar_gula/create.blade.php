        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('SistemPakar.admin.kelola_dm.kadar_gula.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="max-w-xl">
                            ...
                            <x-text-input id="rentan" type="text" name="rentan" class="mt-1 block w-full" value="{{ old('rentan') }}" required />
