                                  ...
                                  <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                        <div x-data="{ action: '' }">
                                            ...
                                            <x-danger-button
                                                x-on:click.prevent="
                                                    action = '{{ route('SistemPakar.admin.kelola_dm.af.destroy', $activity->id) }}';
                                                    $dispatch('open-modal', 'confirm-user-deletion-{{ $activity->id }}')
                                                "
                                            >               
                                                {{ __('Hapus') }}
                                            </x-danger-button>
                                            ...
                                            {{-- Modal Delete --}}
                                            <x-modal name="confirm-user-deletion-{{ $activity->id }}" focusable>
